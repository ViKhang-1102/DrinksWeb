        ...
        <div class="col-xl-4">
          <div class="p-3 border">
            <div class="address mb-3">
              ...
              <p class="mb-0 font-12">Road No. 22, Binh Thanh, Cai Rang, Can Tho</p>
            </div>
            <hr>
            <div class="phone mb-3">
              <h5 class="mb-0 fw-bold">Phone</h5>
              <p class="mb-0 font-13">Toll Free (+84)123-456-789</p>
            </div>
            <hr>
            <div class="email mb-3">
              <h5 class="mb-0 fw-bold">Email</h5>
              <p class="mb-0 font-13">admin@example.com</p>
            </div>
            <hr>
            <div class="working-days mb-0">
              <h5 class="mb-0 fw-bold">Working Days</h5>
              <p class="mb-0 font-13">Mon - FRI / 7:30 AM - 6:30 PM</p>
            </div>
          </div>
        </div>
      </div>
